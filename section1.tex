...
% She can begin with the practice of a basic start. For this blablabla
% Also she can practice to stay with one or both feet, because they are useful for walking on a slackline. With the one feet ousat, the user can balance better on the line on correct some misbehaviors. Practicing both feet on the line she will help for the start of the walking procedure, since you have to move one feet after the other and stay with both feet on the line for a short time.

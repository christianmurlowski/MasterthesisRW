...
\subsubsection{Comparison of tracking technologies}
...
\begin{figure}[htb]
	...
	\begin{minipage}[t]{0.6\linewidth}
		...
		\subcaption{Directional References}
...
\subsubsection{Implementation in balance training scenarios}
